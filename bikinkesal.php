...
<body>
   ...
   <div id='Content'>
     ...
     <div id="loveIn">
       <!-- Tombol LOVE --> <img src="3.gif" style="width:100px;height:50px;"/>
     ...
     <div><div id='pergeseran'>
        ...
        <p><b>
	        <span>Hallo SayangKu</span>
        </b></p>
        
        <p><b>
	        <span>Maaf kalau selalu<br>suka buat kamu marah dan sebel sama aku &#128553; &#128591;</span>
        </b></p>

        <p><b>
	        <span>Aku cuman mau bilang sama km yang</span>
        </b></p>
        
        <p><b>
	        <span>Pencet tanda itu dulu 👉💌 &#128149;</span>
        </b></p>
        
     </div></div>

     <p id="ketgeser">Klik untuk Menggeser</p>

     <div><blockquote id='bq'>

      <p id="kalimat">Maafin aku ya sayang kalau selama km sama ak masih belum bisa buat km bahagia yang,<br><br> ak masih suka buat km sebel,marah,bt sama ak yang&#128591; &#128591;<br><br>ak juga masih banyak kurangnya dari pada laki-laki lainnya yang dan masih belum bisa jadi pacar atau laki-laki yang km pengen yang.<br><br>tapi ak akan berusaha terus supaya bisa jadi laki-laki yang km pengen,ak juga akan selalu berusaha yang terbaik untuk buat km selalu bahagia seneng selama sama ak yang dan ak akan berjuang terus demi km yang 🤍🤍,  
       <p id="pesanAkhir">stay with me. i love uu 🤍 <br> <img src="4.gif" style="width:100px;height:100px;"/></p>
     </blockquote></div>
